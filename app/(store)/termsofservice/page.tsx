...
export default function TermsOfServicePage() {
    return (
        <div className="p-6 max-w-4xl mx-auto text-gray-800">
            ...
            <p className="mb-4">
                This website is operated by <strong>Spectrastore.in</strong>.
                Throughout the site, the terms “we”, “us” and “our” refer to
                Spectrastore.in. Spectrastore.in offers this website, including
            ...
            <p className="mb-4">
                You also agree to abide by the shipping time and process (both
                local and international) and accept any delays that are not
                directly under our control. For international shipments, you
                agree to wait for the designated period of 25 working days and
                indemnify us of any charges, duties, waiting period, etc. you
                may incur for the shipment.
            </p>
